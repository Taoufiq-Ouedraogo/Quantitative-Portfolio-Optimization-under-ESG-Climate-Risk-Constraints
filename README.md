...
|  Climate |  (3) <br> Temperature alignment constraint | The weighted average portfolio `Implied Temperature Rise [°C]` (ITR) must remain below **2°C** and below the investment universe average |   $$ITR_p = \sum_{i=1} w_i \cdot ITR_i$$  <br>  $$ITR_p \leq 2.0 $$   <br> $$ITR_p \leq \frac{1}{N} \sum_{i=1}^{N} ITR_i$$   |
